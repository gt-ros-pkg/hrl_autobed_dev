...
class DatabaseCreator():
    ...
    def preprocess_home_position(self, p_map_flat, target):
        ...
        pca_pixels.fit(pca_x_pixels)
        #The output of PCA needs rotation by -90 
        rot_x_pixels = pca_pixels.transform(pca_x_pixels)
        ...
        pca_mat.fit(pca_x_mat)
        #The output of PCA needs rotation by -90 
        rot_targets_mat = pca_mat.transform(targets_mat)
    ...
    def pca_transformation_sup(p_map_raw, target_raw):
