...
class PoseTrainer():
    ...
    def begin_training(self):
        ...
        current_dataset.append(self.current_pressure_map) #First we append the pressure map to our list of joints
        self.training_database[self.pose_ID] = current_dataset #assign the current dataset(i.e pressure map and true joint positions) as a value to the pose_ID key.
