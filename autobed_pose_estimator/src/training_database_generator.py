...
class PoseTrainer():
    ...
    def __init__(self, pose_ID, pose_list_file, training_database_file):
        ...
        self.pose_list_file = pose_list_file #This is the file with the pose_IDs matched with the joint positions
        ...
        try:
            ...
            print "[ERROR: PoseTrainer] Can't load said pickle file. Does it exist?"
       
        try:
            self.training_database = load_pickle(self.training_database_file)#Load the database of trained poses
        except pkl.PickleError:
...
if __name__ == "__main__":
    ...
    pose_estimator_trainer = PoseTrainer(int(sys.argv[1]), sys.argv[2], sys.argv[3])
