...
def spectrum_analyzer_callback(data):
    ...
    Be sure to catch it'''
    if spectrum_analyzer_callback.i < 10000:
        spectrum_analyzer_callback.data_array[spectrum_analyzer_callback.i] = data.data
        spectrum_analyzer_callback.i += 1
        rospy.loginfo('[sharp_listener] Iteration number : %f'.spectrum_analyzer_callback.i)

    elif spectrum_analyzer_callback.i == 10000:
        plotSpectrum(spectrum_analyzer_callback.data_array, 100)
        spectrum_analyzer_callback.i += 1
...
spectrum_analyzer_callback.data_array = np.zeros(10000)
...
def prox_driver_listener_for_fft():
    ...
    rospy.Subscriber("/pst0/data", Float32, spectrum_analyzer_callback)
