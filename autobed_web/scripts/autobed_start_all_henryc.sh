...
~/catkin_ws/src/hrl_autobed_dev/autobed_web/scripts/autobed_kill_marvin.sh
...
screen -S autobed-marvin -p hokuyo -X stuff "roslaunch autobed_web autobed_henryc.launch
"
sleep 10
