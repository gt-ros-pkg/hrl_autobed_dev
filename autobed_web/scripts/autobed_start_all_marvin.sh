...
screen -S autobed-marvin -p 0 -X stuff "roslaunch autobed_web autobed_marvin.launch
"
screen -S autobed-marvin -X screen -t fsascan
screen -S autobed-marvin -p 0 -X stuff "~/ros_workspace/git/fsa_mat_64/bin/fsascan
"
